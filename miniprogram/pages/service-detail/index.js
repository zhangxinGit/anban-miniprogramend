...
import { fetchServiceCatalogPage, readServiceItem, rememberServiceItems, resolveServiceCatalogItemCoverSource, } from '../service-market/catalog';
import { cancelServiceBooking, createServiceBooking, getCurrentServiceBooking, } from '../../services/serviceBooking';
import { showAppModal } from '../../utils/modal';
import { requireLogin } from '../../utils/loginGate';
import { getErrorMessage } from '../../utils/errorMessage';
function matchesCurrentBooking(booking, item) {
    return !!booking && !!item && booking.canCancel && booking.serviceCode === item.id;
}
function buildDetailMetaText(item) {
    if (!item) {
        return '';
    }
...
async function prepareServiceItem(item) {
...
Page({
    ...
    onLoad(query) {
        ...
        const page = this;
        const opener = (_a = page.getOpenerEventChannel) === null || _a === void 0 ? void 0 : _a.call(page);
        if (opener === null || opener === void 0 ? void 0 : opener.on) {
            opener.on('service-item', (item) => {
                if (!item)
                    return;
    ...
    onPreviewCover() {
        var _a, _b;
        const coverImg = ((_a = this.data.item) === null || _a === void 0 ? void 0 : _a.coverSrc) || ((_b = this.data.item) === null || _b === void 0 ? void 0 : _b.coverImg) || '';
        if (!coverImg)
            return;
    ...
    onOpenCurrentBookingService() {
        ...
        if (!(currentBooking === null || currentBooking === void 0 ? void 0 : currentBooking.serviceCode) || currentBooking.serviceCode === ((_a = this.data.item) === null || _a === void 0 ? void 0 : _a.id)) {
            return;
        }
        wx.redirectTo({
    ...
    async onBook() {
        ...
        if (!item || this.data.submitting || this.data.currentBookingLoading)
            return;
        if (!requireLogin({
            title: '登录后预约服务',
    ...
    onCallCurrentBookingContact() {
        var _a;
        const phone = ((_a = this.data.currentBooking) === null || _a === void 0 ? void 0 : _a.serviceContact.phone) || '18526209432';
