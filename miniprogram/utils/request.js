...
import { normalizeToAppRole } from '../shared/roles';
...
export function createRequestTraceId(prefix = 'mp') {
...
function saveLastRequestTraceId(traceId) {
    try {
...
function getErrorCode(value, fallback) {
...
function getRequestHeader(input) {
...
function buildNetworkErrorMessage(err, url) {
...
export async function request(options) {
    ...
    const traceId = typeof header['X-Debug-Trace-Id'] === 'string' && header['X-Debug-Trace-Id'].trim()
    ...
    return await new Promise((resolve) => {
        wx.request({
            ...
            success: (res) => {
                ...
                if ((body === null || body === void 0 ? void 0 : body.role) !== undefined && (body === null || body === void 0 ? void 0 : body.role) !== null) {
                    roleStore.setRole(normalizeToAppRole(body.role));
                }
                else if ((bodyData === null || bodyData === void 0 ? void 0 : bodyData.role) !== undefined && bodyData.role !== null) {
                    roleStore.setRole(normalizeToAppRole(bodyData.role));
                }
                const nextRole = getAuthState().role;
                // 兼容后端 ApiResponse：{ code, msg, data }
                if (typeof (body === null || body === void 0 ? void 0 : body.code) === 'number') {
                    if (body.code === 0) {
                        resolve({ ok: true, data: body.data, role: nextRole });
                        return;
                    }
                    resolve({
                        ok: false,
                        message: typeof (body === null || body === void 0 ? void 0 : body.msg) === 'string' && body.msg ? body.msg : '请求失败',
                        code: body.code,
                        role: (body === null || body === void 0 ? void 0 : body.role) !== undefined ? normalizeToAppRole(body.role) : undefined,
                    });
                    return;
                }
                ...
                if (res.statusCode >= 200 && res.statusCode < 300) {
                    resolve({ ok: true, data: body, role: nextRole });
                    return;
                }
                resolve({
                    ok: false,
                    message: typeof (body === null || body === void 0 ? void 0 : body.message) === 'string' && body.message ? body.message : `HTTP ${res.statusCode}`,
