...
function accessFile(filePath) {
    return new Promise((resolve) => {
        var _a;
        const fs = (_a = wx.getFileSystemManager) === null || _a === void 0 ? void 0 : _a.call(wx);
        if (!fs) {
            resolve(false);
            return;
        }
...
export function isDataImageUrl(src) {
 ...
 */
export async function resolveMiniProgramImageSrc(src) {
